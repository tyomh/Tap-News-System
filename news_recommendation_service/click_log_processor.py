...
LOG_CLICKS_TASK_QUEUE_URL = "amqp://hsdghhwc:6S3OQO2CnHqKx8gO51eNPEf31KHW79vV@termite.rmq.cloudamqp.com/hsdghhwc"
...
def handle_message(msg):
    ...
    for i, prob in model['preference'].iteritems():
        if not i == click_class:
            model['prefernce'][i] = float((1 - ALPHA) * model['prefernce'][i])
